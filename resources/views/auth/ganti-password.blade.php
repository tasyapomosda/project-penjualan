...
<head>
    ...
    <title>Ganti Password - Showcase Snack</title>
...
<body class="flex items-center justify-center p-6">
    ...
    <div class="w-full max-w-sm">
        @if(session('success'))
        <div class="mb-4">
            <div class="bg-green-50 border border-green-300 p-3 rounded-xl flex items-center gap-2 text-green-600 text-xs">
        ...
        <div class="glass-card rounded-[2rem] p-8 shadow-xl shadow-indigo-100">
            <div class="text-center mb-8">
                <div class="inline-flex p-3 rounded-2xl bg-indigo-50 mb-4">
                    <i data-lucide="key-round" class="text-indigo-500 w-6 h-6"></i>
                </div>
                <h1 class="text-2xl font-bold text-slate-800">Ganti Password</h1>
                <p class="text-slate-400 text-xs mt-1">Perbarui kata sandi akun Anda</p>
            </div>
            ...
            <form action="{{ route('password.update') }}" method="POST" class="space-y-5">
                ...
                <div class="space-y-2">
                    <label class="text-[10px] font-semibold text-slate-500 uppercase tracking-widest ml-1">Password Lama</label>
                    <div class="relative">
                ...
                <div class="space-y-2">
                    <label class="text-[10px] font-semibold text-slate-500 uppercase tracking-widest ml-1">Password Baru</label>
                    <div class="relative">
                ...
                <div class="space-y-2">
                    <label class="text-[10px] font-semibold text-slate-500 uppercase tracking-widest ml-1">Konfirmasi Password Baru</label>
                    <div class="relative">
                        <i data-lucide="key-round" class="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400"></i>
